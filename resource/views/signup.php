<!--Content Itens Menu-->
                    ...
                    <form method="post">
                        ...
                        <input type="text" name="nickname" placeholder=<?php echo $this->nickname ?>><br>
                        <label for="password"><?php echo $this->password ?></label>
                        <input type="text" name="password" placeholder=<?php echo $this->password ?>><br>
                        <label for="email"><?php echo $this->email ?></label>
                        <input type="text" name="email" placeholder=<?php echo $this->email ?>><br>
                        <label for="born"><?php echo $this->born ?></label>
                        <input type="text" name="born" placeholder=<?php echo $this->born ?>><br>
                    </form>